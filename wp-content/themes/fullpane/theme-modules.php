...
function themify_header_and_footer_options() {
	$value = themify_get( 'setting-menu_bar_position' );
	return '
		<div class="themify_field_row">
			...
			<select id="setting-menu_bar_position" name="setting-menu_bar_position">
				<option value="menubar-bottom">' . __( 'Menu bar at the bottom (footer panel at top)', 'themify' ) . '</option>
				<option value="menubar-top" '. selected( $value, 'menubar-top', false ) .'>' . __( 'Menu bar at the top (footer bar at bottom)', 'themify' ) . '</option>
			</select>
		</div>
		<div class="themify_field_row">
			<span class="label"></span>
			<label><input type="checkbox" name="setting-exclude_footer_panel" value="on" ' . checked( 'on', themify_get( 'setting-exclude_footer_panel' ), false ) . '>' . __( 'Exclude footer panel (the footer will be excluded)', 'themify' ) . '</label>
		</div>';
}