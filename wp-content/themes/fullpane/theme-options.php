...
class Themify {
	...
	static $content_width = 1038;
	static $sidebar1_content_width = 708;
	
	// Default Single Post Layout
	static $single_content_width = 1038;
	static $single_sidebar1_content_width = 708;
	
	// Default Single Image Size
	static $single_image_width = 1038;
	static $single_image_height = 500;
	
	// Grid4
	static $grid4_width = 262;
	static $grid4_height = 262;
	
	// Grid3
	static $grid3_width = 362;
	static $grid3_height = 362;
	
	// Grid2
	static $grid2_width = 561;
	static $grid2_height = 561;
	...
	// List Post
	static $list_post_width = 1038;
	static $list_post_height = 1038;

	// Index Portfolio
	static $index_portfolio_image_width = 262;
	static $index_portfolio_image_height = 262;
	...
	public $gallery_by_shortcode = false;
	...
	function __construct() {
		...
		$this->avatar_size = apply_filters('themify_author_box_avatar_size', 70);
	...
	function template_redirect() {
		...
		elseif( is_singular('post') || is_singular('portfolio') ) {
			...
			if(!$is_portfolio){
				...
				if ( themify_check('layout') && themify_get('layout') != 'default' ) {
					$this->layout = themify_get('layout');
			...
			$this->hide_image = (themify_get('hide_post_image') != 'default' && themify_check('hide_post_image')) ? themify_get('hide_post_image') : (!$is_portfolio?themify_get('setting-default_page_post_image'):false);
			$this->unlink_image = (themify_get('unlink_post_image') != 'default' && themify_check('unlink_post_image')) ? themify_get('unlink_post_image') : (!$is_portfolio?themify_get('setting-default_page_unlink_post_image'):false);
